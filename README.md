...
CPU와 메모리 자원에 강한 부하를 발생시켜,  
**단일 처리와 병렬 처리의 차이**, **알고리즘별 부하 특성**, **메모리 사용 패턴**을 비교할 수 있도록 만든  
C++ 기반 콘솔 스트레스 테스트 도구입니다.
...
이 프로젝트는 CPU 및 메모리에 강한 부하를 주는 여러 시나리오를 통해,  
테스트 환경에서 시스템 반응과 처리 성능을 비교·기록할 수 있도록 구성한 도구입니다.
