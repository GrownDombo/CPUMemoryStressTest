...
> 이 저장소는 **C# 프로토타입 버전**과 **C++ 재구현 버전**을 함께 포함하고 있으며, 현재 프로젝트의 핵심 구현은 **C++ 버전**입니다.
...
```text
CPUMemoryStressTestCSharp/   초기 프로토타입 구현
CPUMemoryStressTestCpp/      최종 C++ 구현
README.md                    프로젝트 소개 및 실행 방법
LICENSE                      MIT License
.gitignore                   빌드 산출물 및 개발 환경 파일 제외 설정
```
